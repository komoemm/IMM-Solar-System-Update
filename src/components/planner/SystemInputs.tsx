...
export const SystemInputs: React.FC<SystemInputsProps> = ({ scenario, onChange }) => {
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="bg-slate-900 p-6 rounded-xl border border-slate-800 shadow-xs">
        <div className="flex items-center justify-between pb-4 mb-4 border-b border-slate-800">
          <h4 className="text-lg font-bold text-slate-100">1. Project & Engineering Metadata</h4>
          <StatusBadge status="USER INPUT" />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div>
            <label htmlFor="proj-name" className="block text-xs font-semibold text-slate-300 mb-1">
          ...
          <div>
            <label htmlFor="proj-site" className="block text-xs font-semibold text-slate-300 mb-1">
          ...
          <div>
            <label htmlFor="proj-author" className="block text-xs font-semibold text-slate-300 mb-1">
          ...
          <div>
            <label htmlFor="proj-rev" className="block text-xs font-semibold text-slate-300 mb-1">
              Revision Identifier
            </label>
            <input
              id="proj-rev"
          ...
          <div>
            <label htmlFor="proj-date" className="block text-xs font-semibold text-slate-300 mb-1">
              Calculation Date
            </label>
            <input
              id="proj-date"
          ...
          <div className="md:col-span-2 lg:col-span-3">
            <label htmlFor="proj-notes" className="block text-xs font-semibold text-slate-300 mb-1">
      ...
      <section className="bg-slate-900 p-6 rounded-xl border border-slate-800 shadow-xs">
        <div className="flex items-center justify-between pb-4 mb-4 border-b border-slate-800">
          <div className="flex items-center gap-3">
            <h4 className="text-lg font-bold text-slate-100">2. PV Module Specifications (STC)</h4>
            <StatusBadge status={scenario.panelSpecs.status} />
          </div>
          <div className="flex items-center gap-2">
            <label htmlFor="panel-status" className="text-xs font-medium text-slate-300">Source Status:</label>
            <select
              id="panel-status"
              className="text-xs px-2.5 py-1 border rounded-lg bg-slate-800 text-slate-100 border-slate-600 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none"
              value={scenario.panelSpecs.status}
              onChange={(e) => updatePanel("status", e.target.value as DataStatus)}
            >
              <option value="CONFIRMED SPECIFICATION" className="bg-slate-800 text-slate-100">CONFIRMED SPECIFICATION</option>
              <option value="USER INPUT" className="bg-slate-800 text-slate-100">USER INPUT</option>
              <option value="TO CONFIRM" className="bg-slate-800 text-slate-100">TO CONFIRM</option>
            </select>
          </div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div>
            <label htmlFor="panel-mfr" className="block text-xs font-semibold text-slate-300 mb-1">Manufacturer</label>
            <input
              id="panel-mfr"
              type="text"
              className="w-full px-3 py-2 text-sm bg-slate-800 text-slate-100 border border-slate-600 rounded-lg focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none"
          ...
          <div>
            <label htmlFor="panel-model" className="block text-xs font-semibold text-slate-300 mb-1">Model Name</label>
            <input
              id="panel-model"
              type="text"
              className="w-full px-3 py-2 text-sm bg-slate-800 text-slate-100 border border-slate-600 rounded-lg focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none"
          ...
          <div>
            <label htmlFor="panel-qty" className="block text-xs font-semibold text-slate-300 mb-1">Total Panel Quantity</label>
            <input
              id="panel-qty"
              type="number"
              placeholder="e.g. 170"
          ...
          <div>
            <label htmlFor="panel-watt" className="block text-xs font-semibold text-slate-300 mb-1">Rated Power Pmax (W)</label>
            <input
              id="panel-watt"
              type="number"
              step="1"
          ...
          <div>
            <label htmlFor="panel-vmp" className="block text-xs font-semibold text-slate-300 mb-1">Voltage Vmp at STC (V)</label>
            <input
              id="panel-vmp"
              type="number"
              step="0.1"
          ...
          <div>
            <label htmlFor="panel-voc" className="block text-xs font-semibold text-slate-300 mb-1">Open Circuit Voltage Voc (V)</label>
            <input
              id="panel-voc"
              type="number"
              step="0.1"
          ...
          <div>
            <label htmlFor="panel-imp" className="block text-xs font-semibold text-slate-300 mb-1">Current Imp at STC (A)</label>
            <input
              id="panel-imp"
              type="number"
              step="0.01"
          ...
          <div>
            <label htmlFor="panel-isc" className="block text-xs font-semibold text-slate-300 mb-1">Short Circuit Current Isc (A)</label>
            <input
              id="panel-isc"
              type="number"
              step="0.01"
          ...
          <div>
            <label htmlFor="panel-coeff" className="block text-xs font-semibold text-slate-300 mb-1">
              Voc Temp Coeff (%/°C)
            </label>
            <input
              id="panel-coeff"
            ...
            />
            <p className="text-[10px] text-slate-400 mt-0.5">Negative coefficient, e.g. -0.26</p>
          </div>
          <div>
            <label htmlFor="panel-mintemp" className="block text-xs font-semibold text-slate-300 mb-1">Min Design Temp (°C)</label>
            <input
              id="panel-mintemp"
              type="number"
              placeholder="e.g. 10"
          ...
          <div>
            <label htmlFor="panel-maxtemp" className="block text-xs font-semibold text-slate-300 mb-1">Max Design Temp (°C)</label>
            <input
              id="panel-maxtemp"
              type="number"
              placeholder="e.g. 45"
      ...
      <section className="bg-slate-900 p-6 rounded-xl border border-slate-800 shadow-xs">
        <div className="flex items-center justify-between pb-4 mb-4 border-b border-slate-800">
          <div className="flex items-center gap-3">
            <h4 className="text-lg font-bold text-slate-100">3. Hybrid Inverter Parameters</h4>
            <StatusBadge status={scenario.inverterSpecs.status} />
          </div>
          <div className="flex items-center gap-2">
            <label htmlFor="inv-status" className="text-xs font-medium text-slate-300">Source Status:</label>
            <select
              id="inv-status"
              className="text-xs px-2.5 py-1 border rounded-lg bg-slate-800 text-slate-100 border-slate-600 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div>
            <label htmlFor="inv-mfr" className="block text-xs font-semibold text-slate-300 mb-1">Inverter Manufacturer</label>
            <input
              id="inv-mfr"
              type="text"
              className="w-full px-3 py-2 text-sm bg-slate-800 text-slate-100 border border-slate-600 rounded-lg focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none"
          ...
          <div>
            <label htmlFor="inv-model" className="block text-xs font-semibold text-slate-300 mb-1">Model Name</label>
            <input
              id="inv-model"
              type="text"
              className="w-full px-3 py-2 text-sm bg-slate-800 text-slate-100 border border-slate-600 rounded-lg focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none"
          ...
          <div>
            <label htmlFor="inv-qty" className="block text-xs font-semibold text-slate-300 mb-1">Inverter Units</label>
            <input
              id="inv-qty"
              type="number"
              placeholder="e.g. 2"
          ...
          <div>
            <label htmlFor="inv-pkw" className="block text-xs font-semibold text-slate-300 mb-1">Rated AC Power per Unit (kW)</label>
            <input
              id="inv-pkw"
              type="number"
              placeholder="e.g. 50"
          ...
          <div>
            <label htmlFor="inv-vmax" className="block text-xs font-semibold text-slate-300 mb-1">Max PV Input Voltage (V DC)</label>
            <input
              id="inv-vmax"
              type="number"
          ...
          <div>
            <label htmlFor="inv-mpptmin" className="block text-xs font-semibold text-slate-300 mb-1">MPPT Min Voltage (V)</label>
            <input
              id="inv-mpptmin"
              type="number"
              placeholder="e.g. 150"
          ...
          <div>
            <label htmlFor="inv-mpptmax" className="block text-xs font-semibold text-slate-300 mb-1">MPPT Max Voltage (V)</label>
            <input
              id="inv-mpptmax"
              type="number"
              placeholder="e.g. 850"
          ...
          <div>
            <label htmlFor="inv-mpptcnt" className="block text-xs font-semibold text-slate-300 mb-1">MPPT Trackers per Unit</label>
            <input
              id="inv-mpptcnt"
              type="number"
              placeholder="e.g. 4"
          ...
          <div>
            <label htmlFor="inv-inpmppt" className="block text-xs font-semibold text-slate-300 mb-1">String Inputs per MPPT</label>
            <input
              id="inv-inpmppt"
              type="number"
              placeholder="e.g. 2"
          ...
          <div>
            <label htmlFor="inv-imax" className="block text-xs font-semibold text-slate-300 mb-1">Max Operating Current per MPPT (A)</label>
            <input
              id="inv-imax"
              type="number"
              placeholder="e.g. 32"
          ...
          <div>
            <label htmlFor="inv-iscmax" className="block text-xs font-semibold text-slate-300 mb-1">Max Short-Circuit Current per MPPT (A)</label>
            <input
              id="inv-iscmax"
              type="number"
              placeholder="e.g. 48"
      ...
      <section className="bg-slate-900 p-6 rounded-xl border border-slate-800 shadow-xs">
        <div className="flex items-center justify-between pb-4 mb-4 border-b border-slate-800">
          <div className="flex items-center gap-3">
            <h4 className="text-lg font-bold text-slate-100">4. Battery Storage Specifications</h4>
            <StatusBadge status={scenario.batterySpecs.status} />
          </div>
          <div className="flex items-center gap-2">
            <label htmlFor="bat-status" className="text-xs font-medium text-slate-300">Source Status:</label>
            <select
              id="bat-status"
              className="text-xs px-2.5 py-1 border rounded-lg bg-slate-800 text-slate-100 border-slate-600 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div>
            <label htmlFor="bat-mfr" className="block text-xs font-semibold text-slate-300 mb-1">Battery Manufacturer</label>
            <input
              id="bat-mfr"
              type="text"
          ...
          <div>
            <label htmlFor="bat-model" className="block text-xs font-semibold text-slate-300 mb-1">Model / Chemistry</label>
            <input
              id="bat-model"
              type="text"
          ...
          <div>
            <label htmlFor="bat-volts" className="block text-xs font-semibold text-slate-300 mb-1">Module Nominal Voltage (V)</label>
            <input
              id="bat-volts"
              type="number"
          ...
          <div>
            <label htmlFor="bat-ah" className="block text-xs font-semibold text-slate-300 mb-1">Module Capacity (Ah)</label>
            <input
              id="bat-ah"
              type="number"
          ...
          <div>
            <label htmlFor="bat-series" className="block text-xs font-semibold text-slate-300 mb-1">Modules in Series per Pack</label>
            <input
              id="bat-series"
              type="number"
              placeholder="e.g. 10"
          ...
          <div>
            <label htmlFor="bat-parallel" className="block text-xs font-semibold text-slate-300 mb-1">Parallel Battery Strings</label>
            <input
              id="bat-parallel"
              type="number"
              placeholder="e.g. 2"
          ...
          <div>
            <label htmlFor="bat-dod" className="block text-xs font-semibold text-slate-300 mb-1">Permitted Depth of Discharge (%)</label>
            <input
              id="bat-dod"
              type="number"
              placeholder="e.g. 80"
          ...
          <div>
            <label htmlFor="bat-res" className="block text-xs font-semibold text-slate-300 mb-1">Min Reserve State of Charge (%)</label>
            <input
              id="bat-res"
              type="number"
              placeholder="e.g. 20"
          ...
          <div>
            <label htmlFor="bat-eff" className="block text-xs font-semibold text-slate-300 mb-1">Inverter Efficiency Assumption (%)</label>
            <input
              id="bat-eff"
              type="number"
              placeholder="e.g. 95"
          ...
          <div>
            <label htmlFor="bat-chg" className="block text-xs font-semibold text-slate-300 mb-1">Max BMS Charge Current (A)</label>
            <input
              id="bat-chg"
              type="number"
              placeholder="e.g. 100"
          ...
          <div>
            <label htmlFor="bat-dis" className="block text-xs font-semibold text-slate-300 mb-1">Max BMS Discharge Current (A)</label>
            <input
              id="bat-dis"
              type="number"
              placeholder="e.g. 100"
      ...
      <section className="bg-slate-900 p-6 rounded-xl border border-slate-800 shadow-xs">
        <div className="flex items-center justify-between pb-4 mb-4 border-b border-slate-800">
          <div className="flex items-center gap-3">
            <h4 className="text-lg font-bold text-slate-100">5. Grid & Generator Infrastructure</h4>
            <StatusBadge status={scenario.gridAndGen.status} />
          </div>
          <div className="flex items-center gap-2">
            <label htmlFor="grid-status" className="text-xs font-medium text-slate-300">Source Status:</label>
            <select
              id="grid-status"
              className="text-xs px-2.5 py-1 border rounded-lg bg-slate-800 text-slate-100 border-slate-600 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div>
            <label htmlFor="grid-volts" className="block text-xs font-semibold text-slate-300 mb-1">Grid Nominal Voltage (V AC)</label>
            <input
              id="grid-volts"
              type="number"
              placeholder="e.g. 400"
          ...
          <div>
            <label htmlFor="grid-phase" className="block text-xs font-semibold text-slate-300 mb-1">Phase Configuration</label>
            <select
              id="grid-phase"
              className="w-full px-3 py-2 text-sm bg-slate-800 text-slate-100 border border-slate-600 rounded-lg focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none"
            ...
            >
              <option value="3-phase" className="bg-slate-800 text-slate-100">3-Phase (400V L-L)</option>
              <option value="1-phase" className="bg-slate-800 text-slate-100">1-Phase (230V L-N)</option>
              <option value="Unknown" className="bg-slate-800 text-slate-100">Unknown / To Confirm</option>
            </select>
          </div>
          <div>
            <label htmlFor="grid-freq" className="block text-xs font-semibold text-slate-300 mb-1">Frequency (Hz)</label>
            <input
              id="grid-freq"
              type="number"
              placeholder="e.g. 50"
          ...
          <div>
            <label htmlFor="gen-kva" className="block text-xs font-semibold text-slate-300 mb-1">Generator Rated kVA (Blank if unknown)</label>
            <input
              id="gen-kva"
              type="number"
          ...
          <div>
            <label htmlFor="gen-pf" className="block text-xs font-semibold text-slate-300 mb-1">Generator Power Factor (cos φ)</label>
            <input
              id="gen-pf"
              type="number"
              step="0.05"
          ...
          <div>
            <label htmlFor="gen-cont" className="block text-xs font-semibold text-slate-300 mb-1">Generator Continuous Loading Limit (%)</label>
            <input
              id="gen-cont"
              type="number"
              placeholder="e.g. 80"
          ...
          <div className="sm:col-span-2 lg:col-span-3">
            <label htmlFor="gen-arch" className="block text-xs font-semibold text-slate-300 mb-1">
              Generator Integration Architecture Selection
            </label>
            <select
              id="gen-arch"
              className="w-full px-3 py-2 text-sm bg-slate-800 text-slate-100 border border-slate-600 rounded-lg focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none font-medium"
              value={scenario.gridAndGen.generatorArchitecture}
              onChange={(e) => updateGridGen("generatorArchitecture", e.target.value)}
            >
              <option value="Not selected" className="bg-slate-800 text-slate-100">Not selected — Architecture to confirm before design approval</option>
              <option value="ATS-fed inverter grid-input route" className="bg-slate-800 text-slate-100">Option A: ATS-Fed Inverter Grid Input Route (Common Grid / Gen ATS)</option>
              <option value="Dedicated Solis GEN-port route" className="bg-slate-800 text-slate-100">Option B: Dedicated Solis Hybrid Inverter GEN-Port Route</option>
            </select>
          </div>
        </div>
      </section>
